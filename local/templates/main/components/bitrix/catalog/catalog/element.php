...
if ($obCache->InitCache(36000, serialize($arFilter), "/iblock/catalog")):
    $arCurItem = $obCache->GetVars();
elseif ($obCache->StartDataCache()):
    $arCurItem = array();
    $dbRes = CIBlockElement::GetList(array(), $arFilter, false, Array("nTopCount"=>"1"), array("ID", "IBLOCK_ID", "PROPERTY_CABINET"));

    if(defined("BX_COMP_MANAGED_CACHE")):
        global $CACHE_MANAGER;
        $CACHE_MANAGER->StartTagCache("/iblock/catalog");

        if ($arCurItem = $dbRes->Fetch())
    ...
    $obCache->EndDataCache($arCurItem);
endif;
$template = $arCurItem["PROPERTY_CABINET_VALUE"] == "Y" ? "cabinet" : "";
$GLOBALS['CATALOG_CURRENT_ELEMENT_ID'] = $APPLICATION->IncludeComponent('bitrix:catalog.element', $template, Array(
